  ...
  return (
    <div className="px-5 sticky top-0 z-50 py-[.8em] bg-[#e91e63] lg:px-20 flex justify-between">
      <div className="lg:mr-10 cursor-pointer flex items-center space-x-4">
        <li onClick={()=> navigate("/")} className="logo font-semibold text-gray-300 text-2xl">Food App</li>
      </div>
      ...
      <div className="flex items-center space-x-2 lg:space-x-10">
        ...
        <div className="">
            {auth.user ?(<Avatar onClick={handleAvatarClick} sx={{bgcolor:"white", color:pink[400]}}>
